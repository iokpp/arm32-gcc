...
!  <http://www.gnu.org/licenses/>.
      ...
      parameter (omp_allocator_handle_kind = 4)
      parameter (omp_alloctrait_key_kind = 4)
      parameter (omp_alloctrait_val_kind = 4)
      parameter (omp_memspace_handle_kind = 4)
      parameter (omp_event_handle_kind = 4)
